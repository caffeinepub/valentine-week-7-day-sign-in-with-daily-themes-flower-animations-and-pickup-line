...
export class Backend implements backendInterface {
    ...
    async claimDay(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.claimDay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserValentineData(): Promise<ClaimResponse> {
        if (this.processError) {
            try {
                const result = await this.actor.getUserValentineData();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
